...
contract IgnisTokenStorage {
    ...
    /**
     * @notice Contract which oversees inter-ignisToken operations
     */
    ...
    /**
     * @notice Initial exchange rate used when minting the first IgnisTokens (used when totalSupply = 0)
     */
...
contract IgnisTokenInterface is IgnisTokenStorage {
     ...
     */
    bool public constant isIgnisToken = true;
     ...
     */
    event LiquidateBorrow(address liquidator, address borrower, uint repayAmount, address ignisTokenCollateral, uint seizeTokens);
...
contract IgnisErc20Storage {
    /**
     * @notice Underlying asset for this IgnisToken
     */
